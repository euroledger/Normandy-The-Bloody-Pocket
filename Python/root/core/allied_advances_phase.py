...
def do_allied_victory(army, target_space, activation_die_roll=None):
    ...
    # If US third Army Not Activated and First Army in St Lo -> Avranches
    if (
