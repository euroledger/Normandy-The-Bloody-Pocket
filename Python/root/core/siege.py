...
def calculate_siege_drm(
    attack_strength: int,
    defense_strength: int,
    has_air_support: bool
) -> SiegeDrmResult:
...
SIEGE_TABLE = {
    1: SiegeResult(
        result_type=SiegeResultType.NO_EFFECT,
        combat_steps_eliminated=0,
        space_captured=False
    ),
    2: SiegeResult(
        result_type=SiegeResultType.NO_EFFECT,
        combat_steps_eliminated=0,
    ...
    3: SiegeResult(
        result_type=SiegeResultType.ELIMINATE_1_STEP,
        combat_steps_eliminated=1,
        space_captured=False
    ),
    4: SiegeResult(
        result_type=SiegeResultType.ELIMINATE_2_STEPS,
        combat_steps_eliminated=2,
        space_captured=False
    ),
    5: SiegeResult(
        result_type=SiegeResultType.ELIMINATE_3_STEPS,
        combat_steps_eliminated=3,
        space_captured=False
    ),
    6: SiegeResult(
        result_type=SiegeResultType.SPACE_CAPTURED,
        combat_steps_eliminated=0,
        space_captured=True
    )
}