...
class TestAttackStrengthCard28(unittest.TestCase):
    ...
    def test_01_attack_strength_overcast(self):
        ...
        assert_attack_strengths(test_case=self, armies=self.armies, expected_attack_strengths=expected_attack_strengths, card=card_28, expected_has_air_support=expected_has_air_support)
    ...
    def test_02_attack_strength_partly_clear(self):
        ...
        print("\n  PARTLY CLEAR")
        print("  ============")
        expected_attack_strengths = {"US 1st ARMY": 1, "US 3rd ARMY": 0, "BRITISH XXX CORPS": 0, "BRITISH I CORPS": 1}
        expected_has_air_support = {"US 1st ARMY": True, "US 3rd ARMY": False, "BRITISH XXX CORPS": False, "BRITISH I CORPS": False}
        assert_attack_strengths(test_case=self, armies=self.armies, expected_attack_strengths=expected_attack_strengths, card=card_28, num_jabos=weather.available_jabos, expected_has_air_support=expected_has_air_support)
    ...
    def test_03_attack_strength_clear(self):
        ...
        expected_attack_strengths = {"US 1st ARMY": 1, "US 3rd ARMY": 1, "BRITISH XXX CORPS": 0, "BRITISH I CORPS": 1}
        expected_has_air_support = {"US 1st ARMY": True, "US 3rd ARMY": True, "BRITISH XXX CORPS": False, "BRITISH I CORPS": False}
        assert_attack_strengths(test_case=self, armies=self.armies, expected_attack_strengths=expected_attack_strengths, card=card_28, num_jabos=weather.available_jabos, expected_has_air_support=expected_has_air_support)
